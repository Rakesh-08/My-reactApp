  ...
  return (
    <div style={{ minHeight: "85vh", marginTop: "1em" }}>
      ...
      >
        ...
        />
        <UserProfile player2="other" scoreCard={otherScoreCard} />
      </div>
      ...
      <p>
        {player2 ? (
          ...
          <>
            ...
            <span style={{ color: "pink", fontSize: "1.1em",fontWeight:"bold" }}>
...
let MatchModal = ({
  ...
  if (rounds.length == 3) {
    ...
    if (result["W"] > result["L"]) {
      ...
      result.msg = `Hard luck! you lost the game with ${result["L"]} lost out of 3 matches. Better luck next time.`;
      result.emotion = "😩😩😩";
    } else {
...
let MemoizedUserProfile = React.memo(UserProfile);
